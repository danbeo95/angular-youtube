...
export enum EVideoActions {
    ...
    ADD_NOW_PALYING = '[VIDEO] Add Now Playing',
    REMOVE_NOW_PALYING = '[VIDEO] Remove Now Playing',
...
// Video now playing
export class AddNowPlaying implements Action{
    constructor(public payload:any){}
    public readonly type = EVideoActions.ADD_NOW_PALYING
}
export class RemoveNowPlaying implements Action{
    public readonly type = EVideoActions.REMOVE_NOW_PALYING
}
